#cloud-config
# Per-VM cloud-init seed for the appliance-core blank base image.
# Substituted by lab/stage-core-base.sh.
...
runcmd:
  ...
  # core-init wizard on TTY1 forces the operator to change it before they
  # can mark setup complete. The marker /var/lib/appliance-core-default-password
  # tells the wizard the password is still the factory default.
  - 'echo "@@USERNAME@@:appliance-core-please-change-me" | chpasswd'
  - 'mkdir -p /var/lib && touch /var/lib/appliance-core-default-password'
  # Marker for the orchestrator (lab/build-fresh-base.sh) to poll.
  - 'echo "appliance-core-base-ready: $(date --iso-8601=seconds)" > /var/log/appliance-core-base-ready.marker'
